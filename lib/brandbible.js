...
export const BRAND_BIBLE = {
  WN: {
    ...
    emojis: "🍷 קבוע + אימוג'י לוקיישן ספציפי (🌊 ים, 🏛️ קיסריה, 🌇 גג) + אימוג'י מותאם לתמת האירוע",
  ...
  BG: {
    ...
    emojis: "🍷 יין, 🎟️ כרטיסים, 📅📍 לוגיסטיקה, ❤️🌜🦋 רגשי, ואימוג'י מותאם לתמת האירוע. תמיד בסוף משפט",
